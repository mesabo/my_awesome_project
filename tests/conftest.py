...
# WARNING: Ensure imports from `my_awesome_project` comes after this line
from my_awesome_project import app, settings, db  # noqa
from my_awesome_project.cli import create_user, cli  # noqa
